...
.PHONY: run
run:
	docker run --dns=1.1.1.1 --gpus all --mount type=bind,source=./dbs,target=/dbs 100kb.golang -http-workers=50 -http-chunk-size=500 -hn-fetch-size=1000000 > log.txt 2>&1
